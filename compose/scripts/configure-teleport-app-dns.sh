...
for app in kibana prometheus grafana alertmanager vault adguard traefik minio semaphore keycloak-admin n8n gitlab sonarqube allure playwright harbor wazuh redisinsight kafka-ui supabase-studio netbox dashy platform-monitor docker-runtime; do
