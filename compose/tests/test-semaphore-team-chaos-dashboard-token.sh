...
contains "$playbook" 'Verify the Kubernetes kubeconfig exists'
contains "$playbook" 'Verify Chaos Mesh is installed'
contains "$playbook" '          - get'
contains "$playbook" '          - namespace'
...
contains "$reconciler" 'arguments:("[\"--extra-vars\"'
