...
assert_contains "$vault_agent_compose" 'vault-agent-file:/vault/file'
assert_not_contains "$vault_agent_compose" 'vault-agent-file:/vault/file:z'
assert_not_contains "$vault_agent_compose" 'vault-agent-logs:/vault/logs:z'
