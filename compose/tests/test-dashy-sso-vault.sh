...
assert_contains "$grafana_compose" 'GF_AUTH_PROXY_WHITELIST: ${TRAEFIK_GRAFANA_AUTH_IP:-172.31.254.2}/32'
...
assert_contains "$network_reconciler" '172.31.254.0/29'
assert_contains "$network_reconciler" '172.31.253.0/29'
