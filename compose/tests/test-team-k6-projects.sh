...
grep -Fq 'SCALECART_K6_HOLD_DURATION' "$runner" || fail "runner must translate the k6 hold duration"
grep -Fq 'unset K6_DURATION' "$runner" || fail "runner must clear k6 reserved duration configuration"
